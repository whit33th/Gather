...
export default function InvitePageMotion({
  tripDestination,
  tripId,
  tripTitle,
  redirectHref,
  travelWindowLabel,
}: InvitePageMotionProps) {
  return (
      ...
      <div className="grid w-full gap-6 lg:grid-cols-[0.96fr_1.04fr]">
        ...
        >
          ...
          <p className="mt-5 max-w-lg text-lg text-stone-600">
            Join the shared plan to weigh in on dates, places, budget, and the details that turn a destination into an
            actual trip.
          </p>
        ...
        >
            ...
            <div className="editorial-card-soft rounded-[1.6rem] p-5">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm text-stone-700">{tripDestination}</p>
                </div>
              </div>
            </div>
            ...
            <div className="editorial-card-soft rounded-[1.6rem] p-5">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm text-stone-700">{travelWindowLabel}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <ConvexClientProvider>
            <InviteActions tripId={tripId} redirectHref={redirectHref} />
          </ConvexClientProvider>
        </motion.div>
      </div>
    </div>
