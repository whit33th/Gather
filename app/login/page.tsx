...
export default function LoginPage() {
  return (
    <>
      ...
      <div className=" relative z-10 flex min-h-full flex-col flex flex-1 flex-col justify-end lg:px-10 lg:pb-10 xl:px-14 mx-auto flex w-full max-w-[1440px] flex-1 flex-col justify-end lg:grid lg:grid-cols-[minmax(0,1.15fr)_26rem] lg:items-end lg:gap-10">
