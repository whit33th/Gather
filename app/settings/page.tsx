...
export default function SettingsPage() {
  ...
  const [useTripCoverBackground, setUseTripCoverBackground] = useState(true);
  ...
  if (isLoading || currentUser === undefined) {
    return (
      <AppState
        ...
        description="Preparing profile details and appearance controls."
      />
    );
  }
                ...
                {currentUser ? (
                  <>
                    ...
                    <button
                      ...
                      className="trip-glass-button w-full justify-center rounded-[1.2rem] bg-[color:var(--control-bg)] px-4 py-3 text-sm hover:bg-[color:var(--control-bg-hover)]"
                    >
